...
//#include </Users/subhashmacbook/Desktop/3D_Scanner/libraries_for_3D/VTK/Filters/Core/vtkDelaunay3D.h>
#include <pcl/point_types.h>
#include <pcl/io/ply_io.h>
...
PointCloud<PointXYZ>::Ptr filterPointCloudPerFrame(PointCloud<PointXYZ>::Ptr pointCloudPtr) {
    ...
    statFilter.setStddevMulThresh(100 / pointCloudPtr->size()); // Should depend on size of cloud
...
PCLMesh performSurfaceReconstruction(PCLPointCloud inputPCLPointCloud) {
    ...
    statFilter.setStddevMulThresh(1.5); // 0.6 - 1.0
 ...
 //   vtkSmartPointer<vtkDelaunay3D> delaunay = vtkSmartPointer<vtkDelaunay3D>::New();
    ...
    poisson.setDepth(5.9); // Default is 6
